...
{
    Developed a tool to verify complience of RTL multiprocessor design with ARM formal Memory Model. I worked with aarch64 implementations of semaphore algorithms and tested whether they execute correctly.
}
\cvitem
{2023-2025}
{Product Specialist:}
